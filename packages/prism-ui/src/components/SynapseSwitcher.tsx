  ...
  return (
    <span
      style={{
        ...
        borderRadius: "50%",
        flexShrink: 0,
        background: on ? C.okSoft : C.danger,
        boxShadow: `0 0 5px ${on ? C.okSoft : C.danger}`,
      }}
    />
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: C.textDim, fontWeight: 600, whiteSpace: "nowrap" }}>/{active.namespace}</span>
        {tabs.length > 1 && (
          <span
            style={{
      ...
      {open && (
        <div
          style={{
            ...
            boxShadow: "0 30px 80px -24px rgba(var(--shadow-rgb), 0.8)",
          }}
        >
          <div
            style={{
                ...
                style={{
                  ...
                  background: on
                    ...
                    : hovered === t.id
                      ...
                      : "transparent",
                  border: "1px solid " + (on ? "rgba(var(--accent-rgb), 0.4)" : "transparent"),
                }}
              >
                ...
                <span style={{ color: C.textDim, fontWeight: 600, whiteSpace: "nowrap" }}>/{t.namespace}</span>
                <span
                  onClick={(e) => {
                    e.stopPropagation();
                    onClose(t.id);
          ...
          <div
            ...
            style={{
              ...
              fontSize: 14.5,
              color: C.accent2,
              background: hovered === "__add" ? "rgba(var(--accent2-rgb), 0.1)" : "transparent",
            }}
          >
