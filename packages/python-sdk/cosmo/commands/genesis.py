...
wires it into brain.py) and read every one of them in the Code tab, then run
the result from the Test tab.
...
the pieces that spawn or shell out sit beside it in _genesis_run.py and
_genesis_synapse.py.
"""
