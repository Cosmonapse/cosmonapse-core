 ...
 *
 * Everything about "where" is a folder, and Genesis answers that by looking
 * rather than asking - it probes each folder as you browse it, so the
 * primary action follows what is actually there. A folder that already holds
 * a project offers to open it, a folder of projects offers those, and
 * anywhere else offers to scaffold something new. You find out what a folder
 * is by looking at it, not by picking a mode up front.
 */
      ...
      <div style={{ ...cardStyle, position: "relative" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <p style={{ color: C.textDim, fontWeight: 600, fontSize: 15, marginTop: 10, lineHeight: 1.55 }}>
            Start a new brain or open one you already have. Genesis lays it out as a canvas
            you can grow — one Synapse, its Neurons, Engrams and Effectors.
          </p>
        </div>
