...
// The Cosmonapse mark (app/assets/mark.png from the landing page), shared
// verbatim with prism-ui/src/components/Logo.tsx so Genesis and Prism wear
// the same lockup. Replaces the old spinning CSS gradient square.
//
